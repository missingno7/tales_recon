...
recovered()
{
    ...
    G_h01_53EC = F_h00_3870(G_h01_542A, 0xe8);
    F_h00_8C6E(G_h01_53EC, 0xe8);
    G_h01_53EC->field_c = G_h01_53F0;
    G_h01_53EC->field_10 = G_h01_53F4;
    F_h00_8C86(G_h01_53EC, 0xe8, 1);
    F_h00_3930(G_h01_542A, G_h01_53EC, 0xe8);
    F_h00_3850(0x40f10L);
    if (G_h01_53F8) {
        if (G_h01_5422)
        ...
        F_h00_8A8A(G_h01_53DC->field_0->field_24->field_4->field_8, 0x3e80, 0L);
        F_h00_8A8A(G_h01_53DC->field_0->field_24->field_4->field_c, 0x3e80, 0L);
    }
