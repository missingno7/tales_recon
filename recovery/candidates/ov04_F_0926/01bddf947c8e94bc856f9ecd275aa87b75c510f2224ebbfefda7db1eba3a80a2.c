...
struct InputRecord { int x; int y; long data; };

extern long G_h01_46CE;
extern long G_h01_46D2;
extern struct InputRecord G_h01_0320[1];
...
int first,last,rounds;
{
    ...
    for (round = 0; round < rounds; ++round) {
        ...
        for (i = first - 1; i < last; ++i)
            F_h00_35DC(G_h01_0320[i].x, G_h01_0320[i].y,
                G_h01_0320[i].data, 0, 1);
        F_h00_307C();
        F_h00_4376();
        if (G_h01_536E) {
            F_h00_57D2(0);
        ...
        F_h00_86A8((long)((F_h00_463E() & 2) + 1) * 5L);
        F_h00_4376();
        if (G_h01_536E) {
            F_h00_57D2(0);
            return;
