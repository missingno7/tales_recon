...
int a;
{
    ...
    *G_h01_5370=12;
    ...
    F_h00_8AA8(G_h01_46CA,(long)(x+7),(long)y);
    F_h00_8B88(G_h01_46CA,(long)*G_h01_5370);
    F_h00_8B4C(G_h01_46CA,(long)x,(long)(y+32));
    F_h00_8AA8(G_h01_46CA,(long)(x+7),(long)(y+32));
    F_h00_8B88(G_h01_46CA,(long)*G_h01_5370);
    F_h00_8B4C(G_h01_46CA,(long)(x-1),(long)(y-1));
    F_h00_8AA8(G_h01_46CA,(long)(x-1),(long)(y+32));
    F_h00_8B88(G_h01_46CA,(long)*G_h01_5370);
    F_h00_8B4C(G_h01_46CA,(long)(x+7),(long)(y-1));
    F_h00_8AA8(G_h01_46CA,(long)(x+7),(long)(y+32));
    F_h00_307C();
}
