...
extern struct TargetEntry G_h01_470A[35];
extern struct ShortTargetEntry G_h01_4C82[35];
...
recovered()
{
    ...
    for (i = 0; i < 35; i++) {
        G_h01_4524[i].target = (char *)&G_h01_470A[i];
        G_h01_4528[i].target = (char *)&G_h01_4C82[i];
