...
again:
    ...
    if (!mode) {
        ...
        if (!((unsigned char)G_h01_4272[((unsigned)(row-14))*6] & G_h01_0468[value]))
            goto done;
            if (value==4)
                value=13;
            event=&G_h01_4332;
            ...
            *(int *)(event+2)=row;
            ...
            if (!G_h01_46E0 && G_h01_4188)
                ...
                event[6]=1;
            *(int *)(event+8)=G_h01_4274[(unsigned)(row-14)].first;
            *(int *)(event+10)=G_h01_4274[(unsigned)(row-14)].second;
            F_h00_57D2(103);
        }
        goto done;
    }
    if (mode==1) {
        ...
        if (!((unsigned char)G_h01_4272[((unsigned)(row-14))*6] & G_h01_0468[value+5]))
            goto done;
            event=&G_h01_433E;
            event[0]=value+5;
            *(int *)(event+2)=row;
    ...
    if (mode==2) {
        value=(unsigned)F_h00_463E()%5;
        if (!((unsigned char)G_h01_4272[((unsigned)(row-14))*6] & G_h01_0468[value+9]))
            goto done;
            event=&G_h01_434A;
            event[0]=value+9;
            *(int *)(event+2)=row;
